...
<head>
    ...
    <meta name="menu" content="reportProdEstimate"/>
...
<div class="content">
<form:form id="reportForm" modelAttribute="criteria" action="/report/prod-estimate"  method="post">
	...
	<div class="card rounded-16">
        ...
        <div class="card-body py-0">
            <div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="form-group">
						<label><fmt:message key="report.table.th.processOrder" /><span class="text-danger"> *</span></label>
						<input type="text" id="poCode" name="processOrderCode" placeholder="Lệnh sản xuất" value="${criteria.processOrderCode }" autocomplete="off" class="form-control" >
					</div>
				</div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="form-group">
	...
	<div class="row mb-3">
        ...
        <div class="col-12 col-md-6 text-right">
            <a href="/report/prod-estimate-export-excel" id="exportReportInstock" class="btn bgc-warning text-white"><i class="icon-database-export pr-2"></i>Xuất báo cáo</a>
        </div>
    </div>
			...
			<table class="table table-bordered table-striped" id="table-report">
				...
				<tbody id="tbodyReportInstock">
					<c:if test="${empty reports}">
						<tr>
							<td colspan="26" class="text-center text-none-data"><fmt:message key="not.data"/></td>
						</tr>
					</c:if>
