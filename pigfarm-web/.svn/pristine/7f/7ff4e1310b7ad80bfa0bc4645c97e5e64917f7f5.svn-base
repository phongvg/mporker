var ReportProdResultComponent = function() {
	var listFarm;
	...
	var _handleExportReportInstock = function() {
        $('#exportReportInstock').on('click', function(e) {
			...
			let fromDate = _checkRequiredValue('fromDate', "Yêu cầu nhập khoảng thời gian từ!");
			if (fromDate === '') return false;
			let toDate = _checkRequiredValue('toDate', "Yêu cầu nhập khoảng thời gian đến!");
			if (toDate === '') return false;
			e.preventDefault();
            let apiExport;
            if(barnCodesStr !== ''){
				apiExport = '/report/prod-result-export-excel?stockCodes=' + stockCodeStr + '&fromDate=' + fromDate + '&toDate=' + toDate + '&barnCodes='+barnCodesStr;
			} else {
				apiExport = '/report/prod-result-export-excel?stockCodes=' + stockCodeStr + '&fromDate=' + fromDate + '&toDate=' + toDate;
			}
    ...
    var _handleExportReportInstockByPigLevel = function() {
        $('#exportReportInstockByLevel').on('click', function(e) {
            ...
            var apiExport;
            if(barnCodesStr !== ''){
				apiExport = '/report/prod-result-export-excel?type=level&stockCodes=' + stockCodeStr + '&fromDate=' + fromDate + '&toDate=' + toDate + '&barnCodes='+barnCodesStr;
			} else {
				apiExport = '/report/prod-result-export-excel?type=level&stockCodes=' + stockCodeStr + '&fromDate=' + fromDate + '&toDate=' + toDate;
			}
            console.log(apiExport);
            location.href = apiExport;
        });
    ...
    const _checkRequiredValue = function(fieldId, msg) {
...
document.addEventListener('DOMContentLoaded', function() {
	ReportProdResultComponent.init();
});
