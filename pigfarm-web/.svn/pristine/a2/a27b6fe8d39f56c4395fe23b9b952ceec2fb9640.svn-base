...
<head>
    ...
    <meta name="menu" content="reportWeightCompare"/>
...
<div class="content">
<form:form id="reportForm" modelAttribute="criteria" action="/report/weight-compare"  method="post">
	...
	<div class="card rounded-16">
		<div class="row">
			...
			<div class="col-6 text-right">
				<button type="button" class="btn btn-secondary rounded-10  mr-2 mt-2" id="btnReset">Đặt lại</button>
				<button type="button" id="btnSubmit" class="btn btn-secondary rounded-10 mr-2 mt-2"><i class="icon-search4 mr-2"></i><fmt:message key="button.search"/></button>
			</div>
		</div>
            ...
            <div class="row">
            	<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" id="stage" name="stage" placeholder="Ngày ghi nhận sự kiện DD/MM/YYYY" value="${criteria.stage }" autocomplete="off" class="form-control rounded-10" >
					</div>
				</div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
	...
	<div class="row mb-3">
        ...
        <div class="col-12 col-md-6 text-right">
            <a href="/report/weight-compare-export-excel" id="exportReportInstock" class="btn bgc-warning text-white"><i class="icon-database-export pr-2"></i>Xuất báo cáo</a>
        </div>
    </div>
			...
			<table class="table table-bordered table-striped" id="table-report">
				<thead>
					<tr class="table-success">
						...
						<th class="bgc-primary border-primary text-white"><fmt:message key="goodsissue.batch" /></th>
				...
				<tbody id="tbodyReportInstock">
					...
					<c:forEach items="${report}" var="rp" varStatus="cnt">
						<tr>
							...
							<td class="text-center">${rp.batch }</td>
...
<script src="<c:url value='/themes/admin/assets/js/report-weight-compare.js'/>"></script>
