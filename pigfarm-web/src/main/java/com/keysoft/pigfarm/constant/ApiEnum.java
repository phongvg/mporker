...
public enum ApiEnum {
	...
	// ----- COMPANY -----------//
	PATH_COMPANY_GETS("company-gets"),
	PATH_COMPANY_GET("company-get"),
	PATH_COMPANY_CREATE("company-create"),
	PATH_COMPANY_UPDATE("company-update"),
	PATH_COMPANY_SEARCH("company-search"),
	...
	PATH_BARN_PLAN_CREATE("barn-plan-create"),
	...
	PATH_PLANT_CREATE("plant-create"),
	PATH_PLANT_UPDATE("plant-update"),
	PATH_PLANT_SEARCH("plant-search"),
	...
	PATH_PROCESS_ORDER_CREATE("process-order-create"),
	...
	PATH_BARN_GET_ALL("barn-get-all"),
	PATH_BARNS_BY_FARMCODE("barn-gets-by-farmcode"),
	PATH_BARN_BY_CODE_GET("barn-get"),
	PATH_BARN_BY_ID("barn-get-by-id"),
	PATH_BARN_UPDATE("barn-update"),
	PATH_BARN_CREATE("barn-create"),
