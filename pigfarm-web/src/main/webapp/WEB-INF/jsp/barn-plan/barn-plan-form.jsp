...
<div class="content">
  <form:form id="barnPlanForm" modelAttribute="barnPlan" action="${ctx}/barnPlan/confirm" method="post" role="form">
    <form:hidden path="id"/>
    <form:hidden path="barnEmptyDate" id="barnEmptyDate"/>
              ...
              <div class="row">
                <div class="col-xs-6 col-md-3">
                  <div class="form-group">
                    ...
                    <c:choose>
                      ...
                      <c:otherwise>
                        <select	id="planBarnCode" name="barnCode" class="form-control select2" data-placeholder="Chọn mã khu vực">
                          <option value=""></option>
                          <c:forEach var="item" items="${barns}">
                            <option value="${item.code}" ${item.code == barnPlan.barn.code ? 'selected="selected"' : ''}><c:out value="${item.code} - ${item.name}"></c:out></option>
                          </c:forEach>
                        </select>
                      </c:otherwise>
                    </c:choose>
                ...
                <div class="col-xs-6 col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" id="planBarnType" name="pigType" value="${barnPlan.pigType}" class="form-control"/>
                  </div>
                </div>
                <div class="col-xs-6 col-md-3">
                  <div class="form-group">
                    <label><fmt:message key="barnPlan.barnVolumn" /><span class="help-block"></span></label>
                    <input type="text" id="barnVolumn" name="barnVolumn" value="${barnPlan.barnVolumn}" class="form-control" />
                  </div>
                </div>
                <div class="col-xs-6 col-md-3">
                  <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-xs-6 col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" id="barnEmptyDateDisplay" value="${barnPlan.barnEmptyDateDisplay}" readonly="readonly" class="form-control daterange-single">
                  </div>
                </div>
                <div class="col-xs-6 col-md-3">
                  <div class="form-group">
                    <label><fmt:message key="barnPlan.realBarnEmptyDate" /><span class="help-block" style="color:red"> *</span></label>
                    <input type="text" id="realBarnEmptyDateDisplay" value="${barnPlan.realBarnEmptyDateDisplay}" readonly="readonly" class="form-control daterange-single">
                  </div>
                </div>
              </div>
            </div>
