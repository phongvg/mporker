...
<div class="content">
    <div class="row mb-3">
        ...
        <div class="col-12 col-md-6 text-right">
            <a id="exportFarm" href="<c:url value='/farm/export'/>" class="btn btn-sm bgc-warning text-white"><i class="icon-file-upload"></i> <fmt:message key="button.export" /></a>
            <security:authorize access="hasAnyRole('ROLE_ADMIN,ROLE_FARM_CREATE')">
                <a id="addFarm" href="<c:url value='/farm/form'/>" class="btn btn-sm bgc-warning text-white"><i class="icon-plus22"></i> <fmt:message key="button.add" /></a>
            </security:authorize>
        </div>
    </div>
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="<c:url value="/farm/form?id=${farm.id}"/>" class="dropdown-item"><i class="icon-pencil7"></i><fmt:message key="button.edit"/></a>
