               	...
               	<table id="tblSelectedMaterials" class="table table-bordered table-striped">
					<thead>
						<tr class="table-success">
							...
							<th class="mw-200"><fmt:message key="goods.requisition.quantity" /></th>
							<th class="mw-200"><fmt:message key="goods.requisition.actuallyImported" /></th>
							<th class="mw-200"><fmt:message key="goods.requisition.retained" /></th>
							<th style="min-width: 185px;"><fmt:message key="purchaserequisition.unit" /></th>
							<th style="min-width: 135px;"><fmt:message key="purchaserequisition.manufacturedDate" /></th>
							<th style="min-width: 135px;"><fmt:message key="purchaserequisition.expiredDate" /></th>
						</tr>
					</thead>
					<tbody>
