              ...
              <div class="row">
                <div class="col-xs-12 col-md-3">
                  <div class="form-group">
                    <div class="form-group">
                      ...
                      <c:choose>
                        <c:when test="${not empty material.id}">
                ...
                <div class="col-xs-12 col-md-3">
                  <div class="form-group">
                    ...
                    <form:input path="groupCode" class="form-control"/>
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-xs-12 col-md-3">
                  <div class="form-group">
                    ...
                    <form:input path="purchasingGroup" class="form-control"/>
                  </div>
                </div>
              </div>
