      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <c:choose>
                <c:when test="${not empty processOrder.id}">
                ...
                <c:otherwise>
                  <input type="text" id="processOrderId" name="code" value="${processOrder.code}" class="form-control" required="required" />
                </c:otherwise>
              </c:choose>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              ...
              <c:choose>
                <c:when test="${not empty processOrder.id}">
                  <input type="text" id="processOrderId" name="barnCode" value="${processOrder.code}" class="form-control" required="required" readonly="readonly" />
                </c:when>
                <c:otherwise>
                  <select	id="processOrderBarnCode" name="barnCode" class="form-control select2" data-placeholder="Chọn mã khu vực">
                    <option value=""></option>
                    <c:forEach var="item" items="${barns}">
                      <option value="${item.code}" ${item.code == processOrder.barn.code ? 'selected="selected"' : ''}><c:out value="${item.code} - ${item.name}"></c:out></option>
                    </c:forEach>
                  </select>
                </c:otherwise>
              </c:choose>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <c:choose>
                ...
                <c:otherwise>
                  <input type="text" id="pigType" name="pigType" value="${processOrder.pigType}" class="form-control"/>
                </c:otherwise>
              </c:choose>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              ...
              <c:choose>
                ...
                <c:otherwise>
                  <input type="text" id="materialName" name="materialName" value="${processOrder.materialName}" class="form-control" />
                </c:otherwise>
              </c:choose>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-md-3">
            <div class="form-group">
              ...
              <input type="text" id="processOrderStartDate" value="${processOrder.startDateDisplay}" readonly="readonly" class="form-control datepicker" required="required" maxlength="19" />
            </div>
          </div>
          <div class="col-xs-12 col-md-3">
            <div class="form-group">
              <label><fmt:message key="processOrder.endDate" /><span class="help-block"></span></label>
              <input type="text" id="processOrderEndDate" value="${processOrder.endDateDisplay}"  readonly ="readonly" class="form-control datepicker" required="required"	maxlength="19" />
          ...
          <div class="col-xs-12 col-md-3">
            <div class="form-group">
              ...
              <form:input path="realQuantity" class="form-control" readonly="true"/>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-md-3">
            <div class="form-group">
              ...
              <c:choose>
                ...
                <c:otherwise>
                  <input type="text" id="processOrderBatch" name="batch" value="${processOrder.batch}" class="form-control" required="required" maxlength="19" />
                </c:otherwise>
              </c:choose>
            </div>
          </div>
          <div class="col-xs-12 col-md-3">
            <div class="form-group">
              ...
              <input type="text" id="pigLevel" name="pigLevel" value="${processOrder.pigLevel}" class="form-control" required="required" maxlength="19"/>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-3 col-xs-12">
            ...
            <input type="text" value="${processOrder.evaluateAmount}" readonly="readonly" class="form-control" />
          </div>
          <div class="col-md-3 col-xs-12">
            <label>Khối lượng đánh giá</label>
            <input type="text" value="${processOrder.evaluateWeigh}" readonly="readonly" class="form-control" />
          </div>
