...
<div class="content">
  <div class="row mb-3">
    ...
    <div class="col-12 col-md-6 text-right">
      <a href="/report/processOrder" id="exportProcessOrder" class="btn btn-sm bgc-warning text-white"><i class="icon-database-export pr-2"></i>Xuất Excel</a>
      <security:authorize access="hasAnyRole('ROLE_ADMIN,ROLE_PROCESS_ORDER_CREATE')">
        <a id="addFarm" href="<c:url value='/processOrder/form'/>" class="btn btn-sm bgc-warning text-white"><i class="icon-plus22"></i> <fmt:message key="button.add" /></a>
      </security:authorize>
    </div>
  </div>
