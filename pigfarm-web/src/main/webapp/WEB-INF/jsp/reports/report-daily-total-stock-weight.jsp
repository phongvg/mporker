...
<head>
    <title><fmt:message key="report.pr.dailyTotalStockWeight.title"/></title>
    <meta name="menu" content="reportDailyTotalStockWeightMenu"/>
...
<form:form id="planForm" modelAttribute="criteria" action="/report/pr/feed"  method="post">
	...
	<div class="card">
		<div class="card-header">
			<span class="text-uppercase font-size-lg font-weight-bold"><fmt:message key="report.dailyTotalStockWeight.title"/></span>
...
<script src="<c:url value='/themes/admin/assets/js/reportDailyTotalStockWeight.js'/>"></script>
