...
<head>
    ...
    <meta name="menu" content="reportProdResult"/>
...
<div class="content">
<form:form id="reportForm" modelAttribute="criteria" action="/report/prod-result"  method="post">
			...
			<table class="table table-bordered table-striped" id="table-report">
				...
				<tbody id="tbodyReportInstock">
					<c:if test="${empty reports}">
						<tr>
							<td colspan="24" class="text-center text-none-data"><fmt:message key="not.data"/></td>
						</tr>
					</c:if>
