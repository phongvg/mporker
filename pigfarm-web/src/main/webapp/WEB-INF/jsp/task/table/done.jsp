...
<div class="task--column done">
  <div class="task--column__title">
    <span><fmt:message key="task.view.mode.table.title.done"/></span>
  </div>
  <div class="task--column__data">
    <c:forEach var="task" items="${criteria.dones}">
  ...
  <c:if test="${criteria.totalDoneElements > 5}">
    <div class="row">
      <div class="col-12 text-center">
        <span class="text-link" id="task--done__showMore">Show more</span>
      </div>
    </div>
  </c:if>
</div>
