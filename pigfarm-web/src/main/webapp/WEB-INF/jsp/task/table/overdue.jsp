...
<div class="task--column overdue">
  <div class="task--column__title">
    <span><fmt:message key="task.view.mode.table.title.overdue"/></span>
  </div>
  <div class="task--column__data">
    <c:forEach var="task" items="${criteria.overdues}">
  ...
  <c:if test="${criteria.totalOverdueElements > 5}">
    <div class="row">
      <div class="col-12 text-center">
        <span class="text-link" id="task--overdue__showMore">Show more</span>
      </div>
    </div>
  </c:if>
</div>
