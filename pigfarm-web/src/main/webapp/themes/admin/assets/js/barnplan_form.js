	...
	var validateForm = function(){
	 ...
	 var submitForm = function(){
		$('#btnSubmit').on('click',function(e){
			...
			var barnEmptyDateDisplay = $('#barnEmptyDateDisplay').val();
			if(barnEmptyDateDisplay) {
				//set lai ngay thang nam
				var str = barnEmptyDateDisplay.split('-');
				var month = Math.abs(str[1]) - 1; //// the month is 0-indexed
				var date = new Date(str[2],month,str[0]).toLocaleDateString('en-GB');
				document.getElementById("barnEmptyDate").value = date;
			}
