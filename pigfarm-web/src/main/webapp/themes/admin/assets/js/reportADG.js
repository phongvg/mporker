...
var ReportADGComponent = function() {
    ...
    *  Export report FCR
    */
    var _handleExportReportADG = function() {
        $('#exportReportADG').on('click', function(e) {
            e.preventDefault();
            var stockCode = _checkStockCodeValue();
            if (stockCode == '') return false;
            var stage = $('#stage').val()
            ...
            var apiExport = '/report/adg-export-excel?stockCode=' + stockCode + '&poCode=' + poCode + '&stage=' + stage;
