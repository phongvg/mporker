			...
			<div class="sidebar-content">
				...
				<div class="sidebar-user d-xs-none">
					<div class="card-body text-center">
						<a href='<c:url value="/"></c:url>'>
							<img src="<c:url value='/themes/login/images/logo.png'/>" width="120" height="70" alt="">
						</a>
					</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class=" nav-item nav-item-submenu ">
							<a  href="#" class="nav-link "><i class="icon-cog3"></i> <span><fmt:message key="menu.farm"/></span></a>
							<ul class="nav nav-group-sub bgc-primary" >
								<security:authorize access="hasAnyRole('ROLE_ADMIN,ROLE_FARM_VIEW')">
									<li class="nav-item"><a menu="companyMenu" href="<c:url value='/company/list'/>" class="nav-link "><i class="icon-office" aria-hidden="true"></i><span><fmt:message key="menu.company"/></span></a></li>
								</security:authorize>
								<security:authorize access="hasAnyRole('ROLE_ADMIN,ROLE_FARM_VIEW')">
									<li class="nav-item"><a menu="plantMenu" href="<c:url value='/plant/list'/>" class="nav-link "><i class="icon-office" aria-hidden="true"></i><span><fmt:message key="menu.plant"/></span></a></li>
								</security:authorize>
								<security:authorize access="hasAnyRole('ROLE_ADMIN,ROLE_FARM_VIEW')">
...
<%--								</li>--%>
								...
								<security:authorize access="hasAnyRole('ROLE_ADMIN,ROLE_GOODS_RECEIPT_REQUISITION_VIEW')">
									<li class="nav-item"><a menu="goodsReceiptRequisitionMenu" href="/goodsReceipt/list" class="nav-link"><fmt:message key="menu.store.import"/></a></li>
								</security:authorize>
								<security:authorize access="hasAnyRole('ROLE_ADMIN,ROLE_GOODS_ISSUE_REQUISITION_VIEW')">
									<li class="nav-item"><a href="/goodsIssue/list" menu="goodsIssueRequisitionMenu"  class="nav-link"><fmt:message key="menu.store.export"/></a></li>
								</security:authorize>
