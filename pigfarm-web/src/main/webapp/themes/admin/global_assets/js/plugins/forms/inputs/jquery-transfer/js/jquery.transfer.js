...
;(function($) {
    ...
    let Transfer = function(element, options) {
        ...
        this.defaults = {
            ...
            selectedControlName: "selectedItems"
        };
        // merge options
    ...
    Transfer.prototype.generate_item = function(id, index, value, labelText) {
    	let selectedControlName = this.settings.selectedControlName;
        return '<li class="transfer-double-selected-list-li  transfer-double-selected-list-li-' + id + ' .clearfix">' +
        '<div class="checkbox-group">' +
        '<input type="checkbox" value="' + value + '" class="checkbox-normal checkbox-selected-item-' + id + '" id="selectedCheckbox_' + index + '_' + id + '" name="' + selectedControlName + '">' +
